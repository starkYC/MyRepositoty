...
{
    _finishedCount++;
    NSLog(@"Prefetched %ld out of %lu", (unsigned long)_finishedCount, (unsigned long)[self.prefetchURLs count]);
...
{
    _finishedCount++;
    NSLog(@"Prefetched %ld out of %lu (Failed)", (unsigned long)_finishedCount, (unsigned long)[self.prefetchURLs count]);
